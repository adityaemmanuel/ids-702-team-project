---
title: "Small Business Load Statistical Analysis Plan"
author: "Heather Qiu, Isha Singh, Jenny Shen, Aditya John"
date: "`r Sys.Date()`"
output:
...
# __Models__
```{r m, echo = TRUE, results = "asis", message = FALSE, warning = FALSE, fig.width=5,fig.height=4,fig.align='center'}
```

# __Variable Selection__
```{r vs, echo = TRUE, results = "asis", message = FALSE, warning = FALSE, fig.width=5,fig.height=4,fig.align='center'}
```
