...
2.	The second challenge is that a handful of variables are in line with the outcome variable, balance gross, MIS status, and charge-off amount. These variables have to be excluded from the analysis as they are all bi-variate outcomes. 
